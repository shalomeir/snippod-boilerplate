(function(global, undefined) {
    ...
    // Anonymous commons are pushed onto a queue so that (when ready) they can
    ...
    global.install = function(id, module) {
        ...
        // string followed by a module definition. Note that named commons are
        ...
        // identifier. Anonymous commons are executed in order of
    ...
    function require(moduleId) {
        ...
        // Since commons are evaluated only after all their requirements have
    ...
    // module and refuses to evaluate any commons if `flushing` is truthy
    // already.
    var flushing;
