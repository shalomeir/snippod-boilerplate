...
Compilation.prototype.seal = function seal(callback) {
	...
	this.applyPlugins("optimize-commons", this.modules);
	this.applyPlugins("after-optimize-commons", this.modules);
	...
	this.applyPluginsAsync("optimize-tree", this.chunks, this.modules, function(err) {
		...
		this.applyPlugins("revive-commons", this.modules, this.records);
		...
		if(shouldRecord)
			this.applyPlugins("record-commons", this.modules, this.records);
