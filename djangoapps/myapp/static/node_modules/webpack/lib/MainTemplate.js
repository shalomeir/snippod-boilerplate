...
function MainTemplate(outputOptions) {
	...
	this.plugin("render", function(bootstrapSource, chunk, hash, moduleTemplate, dependencyTemplates) {
		...
		source.add("/******/ (function(commons) { // webpackBootstrap\n");
	...
	this.plugin("require", function(source, chunk, hash) {
		return this.asString([
			...
			"commons[moduleId].call(module.exports, module, module.exports, " + this.renderRequireFunctionForModule(hash, chunk, "moduleId") + ");",
			"",
	...
	this.plugin("require-extensions", function(source, chunk, hash) {
		...
		buf.push("");
		buf.push("// expose the commons object (__webpack_modules__)");
		buf.push(this.requireFn + ".m = commons;");
...
MainTemplate.prototype.renderAddModule = function(hash, chunk, varModuleId, varModule) {
	return this.applyPluginsWaterfall("add-module", "commons[" + varModuleId + "] = " + varModule + ";", chunk, hash, varModuleId, varModule);
};
