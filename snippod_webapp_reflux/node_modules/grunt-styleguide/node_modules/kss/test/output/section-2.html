...
<div role="main" id="kss-main">
  <article id="kss-content">
      ...
      <h1 class="kss-title"><span class="kss-ref">2.1.3</span> - A button suitable for giving stars to someone.</h1>

        <div class="kss-box"><pre><code>Testing indentation for Markdown code.
</code></pre></div>
      ...
      <h1 class="kss-title"><span class="kss-ref">2.1.4</span> - A button suitable for giving stars to someone.</h1>
