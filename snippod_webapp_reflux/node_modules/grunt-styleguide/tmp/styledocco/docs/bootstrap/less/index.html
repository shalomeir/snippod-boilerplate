...
<p><em>If you haven&#39;t used <a href="http://gruntjs.com/">grunt</a> before, be sure to check out the <a href="https://github.com/gruntjs/grunt-docs/blob/master/Getting-started.md">Getting Started</a> guide.</em></p>
<p>From the same directory as your project&#39;s <a href="https://github.com/gruntjs/grunt-docs/blob/master/Getting-started.md">Gruntfile</a> and <a href="https://npmjs.org/doc/json.html">package.json</a>, install this plugin with the following command:</p>
...
})</textarea><p>An example configuration can be viewed <a href="https://gist.github.com/3932026">here</a></p>
...
<li><p>0.2.17</p>
<ul>
<li>Fix KssStateGenerator ( @stickel )</li>
</ul>
</li>
<li><p>0.2.16</p>
<ul>
<li>Remove direct dependency upon grunt-lib-contrib</li>
<li>Readme fix ( @firehist )</li>
<li>Readme fix ( @ryanmargheriti )</li>
<li>Readme fix ( @andrew-luhring )</li>
</ul>
</li>
<li><p>0.2.15</p>
<ul>
<li>Dependencies updates ( @shinnn )</li>
<li>Move helper out of tasks directory to avoid &quot;No tasks were registered or unregistered.&quot; warning ( @princed )</li>
<li>Config example error fixes ( @levito  )</li>
</ul>
</li>
<li><p>0.2.14</p>
<ul>
<li>Lock version of styledocco ( @jreading )</li>
</ul>
</li>
<li><p>0.2.13</p>
<ul>
<li>Relativize absolute paths</li>
<li>Rewrite findBasePath function ( @mikedingjan )</li>
<li>Update Grunt getting started docs url ( @iamblue )</li>
<li>It&#39;s Sass, not SASS ( @kaelig )</li>
</ul>
</li>
<li><p>0.2.12</p>
<ul>
<li>Cleanup release history</li>
<li>Use inherited version of LESS ( @pokornyr )</li>
<li>Small documentation typo ( @simonwjackson )</li>
</ul>
</li>
<li><p>0.2.11 | Updated styledocco dependency (#16)</p>
</li>
<li>0.2.10 | KSS fix (#15)</li>
<li><p>0.2.9  | Simplify styledocco plugin</p>
</li>
<li><p>0.2.8</p>
<ul>
<li>Updated styledocco dependencies</li>
<li>Added Stylus</li>
</ul>
</li>
<li><p>0.2.7 | Cumulative fixes (Issues #18, #14, #11) [ sorry for the delay ]</p>
</li>
<li>0.2.6 | Minor code tweaks to resolve some user issues</li>
<li>0.2.5 | Node.js ~0.10.0 compatibility</li>
<li>0.2.4 | Pass local less path to styledocco</li>
<li>0.2.3 | Styleguide nolonger uses custom node-kss fork (includes nolonger supported for KSS beware)</li>
<li>0.2.2 | Grunt 0.4.0 support (~0.3.0 no longer supported)</li>
<li><p>0.2.1 | Minor bug fix</p>
</li>
<li><p>0.2.0</p>
<ul>
